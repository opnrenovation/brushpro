        ...
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.65)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 100, padding: 24 }}>
          <div className="glass" style={{ width: '100%', maxWidth: 480, padding: 32, maxHeight: '90vh', overflowY: 'auto' }}>
            ...
            <div style={{ marginBottom: 12 }}>
              <label style={{ display: 'block', fontSize: 12, color: 'rgba(0,0,0,0.5)', marginBottom: 6 }}>Vendor Name *</label>
            ...
            <div style={{ marginBottom: 12 }}>
              <label style={{ display: 'block', fontSize: 12, color: 'rgba(0,0,0,0.5)', marginBottom: 6 }}>Category</label>
            ...
            <div style={{ marginBottom: 12 }}>
              <label style={{ display: 'block', fontSize: 12, color: 'rgba(0,0,0,0.5)', marginBottom: 6 }}>Contact Name</label>
          ...
          {CATEGORIES.map((c) => (
            <button key={c} onClick={() => setCategoryFilter(c)}
              style={{
                ...
                background: categoryFilter === c ? 'rgba(0,122,255,0.15)' : 'rgba(0,0,0,0.05)',
                color: categoryFilter === c ? '#007AFF' : 'rgba(0,0,0,0.5)',
              }}>
